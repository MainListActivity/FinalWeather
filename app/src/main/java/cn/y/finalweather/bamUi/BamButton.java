package cn.y.finalweather.bamUi;
...
public class BamButton extends Button {
	...
	public BamButton(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public BamButton(Context context, AttributeSet attrs, int defStyle) {
